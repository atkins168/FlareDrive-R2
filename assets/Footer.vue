<template>
  <footer class="footer">
    ...
    <div class="project-links">
      <strong>项目:</strong><a href="https://github.com/atkins168/FlareDrive-R2" target="_blank"
        rel="noopener noreferrer">FlareDrive-R2</a>
      <strong>作者:</strong><a href="https://github.com/atkins168" target="_blank"
        rel="noopener noreferrer">atkins</a>
